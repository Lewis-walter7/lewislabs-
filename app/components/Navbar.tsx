            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className={`glass rounded-2xl px-6 py-3 flex items-center justify-between transition-all duration-300 ${scrolled ? "bg-black/80 shadow-2xl border-white/10" : "bg-transparent border-transparent"
                    ...
                    <div className="hidden md:flex items-center gap-10 text-sm font-semibold">
                        ...
                        <Link href="/#projects" className="text-muted hover:text-white transition-colors">Portfolio</Link>
                        <Link href="/about" className="text-muted hover:text-white transition-colors">About</Link>
                        <Link href="/#contact" className="gradient-primary px-6 py-2.5 rounded-full text-white hover:scale-105 transition-all shadow-lg shadow-primary/30">
                            Start Project
                        </Link>
                    </div>
